...
## Project Structure
    ...
    ├── testapiautosetting_127049  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127049`
...
2. Clone this repo and `cd testapiautosetting_127049`
